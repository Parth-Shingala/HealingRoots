...
<body class="body" style="background-color: rgb(255, 173, 101);">
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="modal fade" id="signupModal" tabindex="-1" role="dialog" aria-labelledby="signupModalLabel"
    ...
    <div class="container my-4" style="background-color: rgb(186, 255, 248);">
        <div class="row featurette d-flex justify-content-center align-items-center">
            ...
            <div class="col-md-5">
                <img class="img" src="images/disease/asthma.jpg" alt="" style="height: 205px;width: 370px;margin-top: 35px;">
        ...
        <div class="row featurette d-flex justify-content-center align-items-center">
            <div class="col-md-7 order-md-2">
                ...
                Naturopathy and Asthma Treatments: Naturopathy treatment is an ancient way of curing any ailment or bodily discomfort 
                through non-surgical methods. It implies the use of ancient and natural therapies over chemically strong medicines and treatments. 
                Since asthma is a condition of the lungs and affects the breathing pattern, naturopaths try and resolve it through natural therapies 
                such as diet therapy. For instance, an asthma patient is put to a certain diet that prohibits the intake of food such as egg, peanuts, 
                shellfish and bread. Similarly, the foods and edibles that benefit an asthma patient are apples, cantaloupe, carrots, flax seeds, garlic 
                and avocado. All these food provide the necessary nutrients to function the lungs optimally and ease Asthma symptoms.</h5>
            </div>
            <div class="order-md-2" style="padding: 10px;">
              <h5 style="color: rgb(57, 83, 255); font-family: Garamond; text-align: justify;margin-top: 20px;font-size: 23px;">
              Other than this, the nature cure centers in India emphasize on the practice of yogic postures and meditations. Breath work postures like Pranayama and Anulam Vilam when practiced under expert guidance are said to benefit the respiratory system and heal the symptoms of Asthma, thereby providing long lasting cure.</h5>
          </div>
          <div class="order-md-2" style="padding: 10px;">
            <h5 style="color: rgb(57, 83, 255); font-family: Garamond; text-align: justify;margin-top: 2px;font-size: 23px;">
              ...
              However there are still researches and studies going on how effectively nature cure therapies can cure asthma completely! The cure other than merely application of therapies depends on the overall lifestyle conditions. Sometime asthma gets acute owing to the habit of excess alcohol intake and drinking of cold fluids, like cold drinks with ice cubes and the like. A disciplined lifestyle in addition to naturopathy is essential to healing and long-term cure. </h5>
        </div>
            <div class="col-md-5 order-md-1">
                <img class="img-fluid" src="images/disease/asthma1.jpg" alt="" style="margin-bottom: 15px;">
