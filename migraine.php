...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="modal fade" id="signupModal" tabindex="-1" role="dialog" aria-labelledby="signupModalLabel"
    ...
    <div class="container my-4" style="background-color: rgb(172, 177, 248);">
        <div class="row featurette d-flex justify-content-center align-items-center">
            <div class="col-md-7">
                <h1 style="color: rgb(244, 98, 98);margin-left: 60px;font-family: Lucida Handwriting;">
                  Migraine
                  </h1>     
            </div>
            <div class="col-md-5">
                <img class="img" src="images/disease/Migraine.jpg" alt="" style="height: 205px;width: 370px;margin-top: 35px;">    
            </div>
        </div>
        <div class="row featurette d-flex justify-content-center align-items-center">
            <div class="col-md-7 order-md-2">
                <h5 style="color: rgb(57, 83, 255); font-family: Garamond; text-align: justify; font-weight: 100;margin-top: 20px;font-size: 23px;">
                    Migraine headaches affect many men and women around the world, although women are found to be 3 times likelier to suffer from this problem than men. These are extremely painful to bear, and frequently accompanied by varied symptoms such as increased sensitivity to light or sound, vomiting and nausea. Before a migraine is sensed completely, some people suffer from an aura or warning sign such as temporary visual loss, spots, flashing lights or zigzag lines. Allopathic doctors recommend quite a few medicines for remedy, but the problem cannot be cured completely. Naturopathic practitioners use natural methods to cure migraines and reduce their duration, intensity and frequency. The methods include the following:</h5>
            </div>
            <div class="order-md-2" style="padding: 10px;">
              <h5 style="color: rgb(57, 83, 255); font-family: Garamond; text-align: justify;font-size: 23px;">
                Lavender Oil: Lavender oil is well-known for its medicinal value, and can also be used for curing migraine headaches. It is low-cost, and can be used safely. Only pure type of Lavender oil should be used for the cure. Oils or fragrances scented with lavender do not yield any results. You need to use pure lavender oil immediately on sensing an impending migraine attack. You can pour just one drop of unadulterated lavender oil behind each ear or on each temple. You may even put 2 – 3 pure lavender oil on the pillow that you would sleep on.</h5>
          </div>
          <div class="order-md-2" style="padding: 10px;">
            <h5 style="color: rgb(57, 83, 255); font-family: Garamond; text-align: justify;font-size: 23px;">
                Balanced diet: Naturopaths often advise patients to stick to a balanced diet, in order to get cured of a wide variety of ailments – including migraines. You should select foods such as whole grains, like oats, barley, quinoa and brown rice, and sweet potatoes. After you suffer a severe onset of migraine vertigo, you need to reduce the intake of chocolate and caffeine over the next 3 days.</h5>
        </div>
            <div class="col-md-5 order-md-1">
                <img class="img-fluid" src="images/disease/mirgraine.jpeg" alt="" style="margin-bottom: 37px;margin-top: 50px;">
